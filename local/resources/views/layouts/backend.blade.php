...
<head>
    ...
    <!-- Favicon icon  -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('local/public/contents/backend')}}/images/favicon.png" />
    <!-- Page title -->
    ...
    <!-- Template assets CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('local/public/contents/backend')}}/css/assets.css">
    <!-- Main style -->
...
<body class="sidebar-mini">
    ...
    <aside class="adminpopular-sidebar">
        <div class="sidebar-user">
            <img class="sidebar-user-avatar" src="{{asset('local/public/contents/backend')}}/images/pic.jpg" alt="User Image">
            <div>
    ...
    <script src="{{asset('local/public/contents/backend')}}/js/jquery.min.js"></script>
    <!-- Bootstrap bundle javascript -->
    <script src="{{asset('local/public/contents/backend')}}/vendors/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- Custom scrollbar javascript -->
    <script src="{{asset('local/public/contents/backend')}}/vendors/scroll/scrollbar.min.js"></script>
    <!-- Waypoints javascript -->
    <script src="{{asset('local/public/contents/backend')}}/js/waypoints.min.js"></script>
    <!-- Chart javascript -->
    <script src="{{asset('local/public/contents/backend')}}/js/chart.js"></script>
    <!-- Jquery counterup javascript -->
    <script src="{{asset('local/public/contents/backend')}}/js/jquery.counterup.min.js"></script>
    @stack('page-script')
    <!-- Custom script -->
    <script src="{{asset('local/public/contents/backend')}}/js/functions.js"></script>
    <script src="{{asset('local/public/contents/backend')}}/js/admin.js"></script>
