...
@push('page-style')
 <link href="{{asset('contents/backend/js/plugins/editor/summernote')}}/css/summernote.min.css" rel="stylesheet">
 @endpush
...
@section('contents')
 ...
 @push('page-script')
  ...
  <script src="{{asset('contents/backend/js/plugins/editor/summernote')}}/js/summernote-lite.min.js"></script>
  <script>
    (function ($) {
         "use strict";
