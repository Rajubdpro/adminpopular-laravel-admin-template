                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img src="{{asset('uploads/setting')}}/{{$edit->favicon}}">
                            @else
                            <img style="width: 20%" src="{{asset('uploads')}}/no-image.png">
                            @endif
                            @error('favicon')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @if($edit->logo != null)
                            <img src="{{asset('uploads/setting')}}/{{$edit->logo}}">
                            @else
...
@push('page-script')
<script src="{{asset('contents/frontend/js/iziToast.min.js')}}"></script>
@if(Session('success'))
